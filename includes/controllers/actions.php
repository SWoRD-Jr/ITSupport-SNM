...
switch ($_POST['action']) {
    ...
    case "addWebService":
        isAuthorized("addAsset");
        $status = Webservice::add($_POST);
        break;

    case "editWebService":
        isAuthorized("editAsset");
        $status = Webservice::edit($_POST);
        break;

    case "deleteWebService":
        isAuthorized("deleteAsset");
        $status = Webservice::delete($_POST['id']);
        break;
    
    // web services account numbers
    case "addAccountNumber":
        isAuthorized("addAsset");
        $status = Attribute::addAccountNumber($_POST);
        break;

    case "editAccountNumber":
        isAuthorized("editAsset");
        $status = Attribute::editAccountNumber($_POST);
        break;

    case "deleteAccountNumber":
        isAuthorized("deleteAsset");
        $status = Attribute::deleteAccountNumber($_POST['id']);
        break;
    ...
    case "addWebServiceCategory":
        isAuthorized("manageData");
        $status = Attribute::addWebServiceCategory($_POST);
        break;

    case "editWebServiceCategory":
        isAuthorized("manageData");
        $status = Attribute::editWebServiceCategory($_POST);
        break;

    case "deleteWebServiceCategory":
        isAuthorized("manageData");
        $status = Attribute::deleteWebServiceCategory($_POST['id']);
        break;
