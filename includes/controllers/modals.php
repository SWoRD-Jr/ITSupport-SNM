...
switch ($_GET['modal']) {
    ...
    case "webservicecategories/edit":
        $category = getRowById("webservicecategories", $_GET['id']);
        break;
    
    case "accountnumbers/edit":
        $accountnumber = getRowById("accountnumbers", $_GET['id']);
        $suppliers = getTable("suppliers");
        break;
    
    case "accountnumbers/add":
        $suppliers = getTable("suppliers");
        break;
    ...
    // webservices
    //case "webservices/assignWebService":
    //    if ($isAdmin) {
    ...
    case "projects/add":
        $clients = getTable("clients");
        $managers = getTableFiltered("people", "type", "admin");
        break;
